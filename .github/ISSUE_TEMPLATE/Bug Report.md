...
**Indicar el tipo de servidor** 🗄 (digita una X -sin dejar espacios- entre los paréntesis de la opción seleccionada)
- [ ] On-premise 🖥️
- [ ] Cloud ☁
...
**¿En qué canales ocurre este problema?** 🏷 (digita una X -sin dejar espacios- entre los paréntesis de la opción seleccionada)
...
**¿El incidente fue reproducido y validado en otras instancias?** ▶  (digita una X -sin dejar espacios- entre los paréntesis de la opción seleccionada)
...
- Seleccionar el proyecto en: Projects-> uContact  👉
- No asignar el issue a un desarrollador🚫
